...
Future<File> generateVehicleInvoicePdf(Map<String, dynamic> data) async {
  ...
  final rentalPeriod = data['locationVehiclePeriod'] as String;
        ...
        children: [
          ...
          pw.Container(
            ...
            child: pw.Column(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                pw.Text('Nom du véhicule : ${data['name']}',
                    style: const pw.TextStyle(fontSize: 12)),
                pw.Text('Classe : ${data['class']}',
                    style: const pw.TextStyle(fontSize: 12)),
                pw.Text('Nom de passagers : ${data['person']}',
                    style: const pw.TextStyle(fontSize: 12)),
                pw.Text(
                    'Période de location : ${AppConstants.extractFormattedDateRange(rentalPeriod)}',
                    style: const pw.TextStyle(fontSize: 12)),
                pw.Text('Nom du chauffeur: ${data['driver']}',
                    style: const pw.TextStyle(fontSize: 12)),
                pw.SizedBox(height: 12),
                pw.Text('Coût journalier : ${data['price']} FCFA',
                    style: const pw.TextStyle(fontSize: 12)),
                pw.Text('Coût total : ${data['totalPrice']} FCFA',
                    style: const pw.TextStyle(fontSize: 12)),
