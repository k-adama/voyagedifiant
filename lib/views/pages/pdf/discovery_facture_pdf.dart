...
Future<File> generateDiscoveryInvoicePdf(Map<String, dynamic> data) async {
  ...
  final rentalPeriod = data['reservationPeriod'] as String;
        ...
        children: [
          ...
          pw.Container(
            ...
            child: pw.Column(
              crossAxisAlignment: pw.CrossAxisAlignment.start,
              children: [
                pw.Text('Nom du site : ${data['name']}',
                    style: const pw.TextStyle(fontSize: 12)),
                pw.Text('Classe : ${data['class']}',
                    style: const pw.TextStyle(fontSize: 12)),
                pw.Text(
                    'Lieu decrassemblement : ${data['lieuDeRassemblement']}',
                    style: const pw.TextStyle(fontSize: 12)),
                pw.Text(
